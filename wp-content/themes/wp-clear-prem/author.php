		...
		<div id="contentleft" class="maincontent">
			...
			<div id="content" class="clearfix">
				...
				<div class="auth-bio auth-archive clearfix">
					...
					<?php } ?>
					<h1><?php _e("Author Archive", "solostream"); ?>: <?php echo $curauth->display_name; ?></h1>
					...
					<p class="auth-icons">
						...
						<a rel="external" title="<?php echo $curauth->display_name; ?> <?php _e("on Google Buzz", "solostream"); ?>" href="http://www.google.com/profiles/<?php echo $curauth->googbuzz; ?>/"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/google-buzz.png" alt="<?php _e("Google Buzz", "solostream"); ?>" /></a>
						<?php } ?>
