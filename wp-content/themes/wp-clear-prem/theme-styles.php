...
// Wrap (Page) Styles
	...
	if ( $page_box_shadow == "Yes" )
		$wrapper .= 'box-shadow:0px 1px 5px rgba(0,0,0,.2);-moz-box-shadow:0px 1px 5px rgba(0,0,0,.2);-webkit-box-shadow:0px 1px 5px rgba(0,0,0,.2);';
...
// Site Title Styles
	...
	if ( $head_banner == "yes" )
		$output .= '#sitetitle {float:left;width:460px;}' . "\n";
...
// Site Title Logo Styles
	...
	if ( $site_title_option == "Image/Logo-Type Title" && $site_logo_url )
		$output .= '#head-content {background-image:url('.$site_logo_url.');background-position:'.$site_logo_position.';background-repeat:no-repeat;}' . "\n";
	if ( $header_bg_color )
		$output .= '#head-content {padding-right:15px;padding-left:15px;width:960px;background-color:'.$header_bg_color.';}' . "\n";
	if ( $site_logo_height )
		$output .= '#head-content {height:'.$site_logo_height.';}' . "\n";
...
// Cat Navigation Adjustments
	...
	if ( $catnav_bg_color )
		$catnav .= 'background:'.$catnav_bg_color.';';
...
// Button Colors
	...
	if ( $button_bg )
		$output .= '#searchform #submitbutton,p.email-form .subbutton,a.comment-reply-link,a.comment-reply-link:link,a.comment-reply-link:visited,#commentform input#submit,.archive-tabs a,.archive-tabs a:link,.archive-tabs a:visited {background-color:'.$button_bg.';}' . "\n";
	if ( $button_font )
		$output .= '#searchform #submitbutton,p.email-form .subbutton,a.comment-reply-link,a.comment-reply-link:link,a.comment-reply-link:visited,#commentform input#submit,.archive-tabs a,.archive-tabs a:link,.archive-tabs a:visited {color:'.$button_font.';}' . "\n";
	if ( $button_hover_bg )
		$output .= '#searchform #submitbutton:hover,p.email-form .subbutton:hover,a.comment-reply-link:hover,a.comment-reply-link:active,#commentform input#submit:hover,.archive-tabs a:hover,.archive-tabs a:active,.archive-tabs .ui-tabs-selected a {background-color:'.$button_hover_bg.';}' . "\n";
	if ( $button_hover_font )
		$output .= '#searchform #submitbutton:hover,p.email-form .subbutton:hover,a.comment-reply-link:hover,a.comment-reply-link:active,#commentform input#submit:hover,.archive-tabs a:hover,.archive-tabs a:active,.archive-tabs .ui-tabs-selected a {color:'.$button_hover_font.';}' . "\n";
...
// Footer Adjustments
	...
	if ( $footer_font_size )
		$footer .= 'font-size:'.$footer_font-size.';';
