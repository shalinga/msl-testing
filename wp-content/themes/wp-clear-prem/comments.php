		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<?php else : ?>
				...
				<?php if ( $user_ID ) : ?>
					...
					<p><?php _e("Logged in as"); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a> | <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php _e("Logout", "solostream"); ?>"><?php _e("Logout", "solostream"); ?></a></p>
				...
				<?php else : ?>
					...
					<label for="email">Email <?php if ($req) echo __("( required; will not be published )", "solostream"); ?></label></p>
