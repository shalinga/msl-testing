...
// Subscription Form and Contact Settings
	...
	$options[] = array(
			"name" => __("Google Buzz Username", "solostream"),
			"id" => $shortname."_gbuzz_url",
			"std" => "",
			"type" => "text",
			"pre" => "http://www.google.com/profiles/",
			"help" => __("Enter your Google Buzz Profile Username.", "solostream"));

	$options[] = array(
			"name" => __("Google Buzz Link Text", "solostream"),
			"id" => $shortname."_gbuzz_link_text",
			"std" => __("Connect on Google Buzz", "solostream"),
			"type" => "textarea",
			"help" => "");
...
// Featured Videos
	...
	$options[] = array(
			...
			"help" => __("Select the number of featured videos you'd like to show (maximum 5).", "solostream"));
...
//	$options[] = array(
//			"name" => __("Sidebar Background Color", "solostream"),
...
// Button Colors
	...
	$options[] = array(
			...
			"type" => "text-color",
			"std" => "",
			"help" => __("Select a background color for the search submit button, email submit button, comments submit button and comments reply button. Leave blank to use default color. Click on field to show color picker.", "solostream"));
	...
	$options[] = array(
			...
			"type" => "text-color",
			"std" => "",
			"help" => __("Select a font color for the search submit button, email submit button, comments submit button and comments reply button. Leave blank to use default color. Click on field to show color picker.", "solostream"));
	...
	$options[] = array(
			...
			"type" => "text-color",
			"std" => "",
			"help" => __("Select a hover background color for the search submit button, email submit button, comments submit button and comments reply button. Leave blank to use default color. Click on field to show color picker.", "solostream"));
	...
	$options[] = array(
			...
			"type" => "text-color",
			"std" => "",
			"help" => __("Select a hover font color for the search submit button, email submit button, comments submit button and comments reply button. Leave blank to use default color. Click on field to show color picker.", "solostream"));
...
function solostream_admin_head() { ?>
	...
	<!-- Solostream Admin StyleSheet -->
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/admin/settings.css" type="text/css" media="screen" />

	<?php /* Solostream Admin Javascript */ 
...
<div id="settings-wrap" class="clearfix">
	...
	<div id="settings-nav" class="clearfix">
		<ul>
			<li><a target="blank" href="http://www.solostream.com"><?php _e("Solostream", "solostream"); ?></a></li>
			<li><a target="blank" href="http://<?php echo get_option('solostream_themename'); ?>.solostreamsites.com/category/tutorials/"><?php _e("Install Guide &amp; Tutorials", "solostream"); ?></a></li>
			<li><a target="blank" href="http://www.solostream.com/forum/index.php?topic=3085.0"><?php _e("Support Forum", "solostream"); ?></a></li>
			<li><a href="http://<?php echo get_option('solostream_themename'); ?>.solostreamsites.com/images.zip"><?php _e("Download PSDs", "solostream"); ?></a></li>
		</ul>
	</div>
	...
	<div id="welcome" class="content">
		...
		<div class="help2">
			<p><?php _e("For many reasons, <strong>we do not provide theme support via site comments or email</strong>. If you need help with your theme, please use the links below. Thanks in advance for your understanding.","solostream"); ?></p>

			<ol>
				<li><a target="blank" href="http://<?php echo get_option('solostream_themename'); ?>.solostreamsites.com/category/tutorials/"><?php _e("Install Guide &amp; Tutorials", "solostream"); ?></a></li>
				<li><a target="blank" href="http://www.solostream.com/forum/index.php?topic=3085.0"><?php _e("Solostream Support Forum", "solostream"); ?></a></li>
			</ol>
		</div>


		<h2 class="heading2"><?php echo get_option('solostream_themename'); ?> <?php _e("Tutorials","solostream"); ?></h2>

		<div class="help2">
			<?php
			$tutsfeed = 'http://'.get_option("solostream_themename").'.solostreamsites.com/category/tutorials/feed/';
			include_once(ABSPATH.WPINC.'/rss.php'); // path to include script
			$feed = fetch_rss($tutsfeed); // specify feed url
			...
			<ol>
				...
				<li><a target="blank" href="<?php echo $item['link']; ?>"><?php echo $item['title']; ?></a></li>
				<?php endforeach; ?>
				<?php endif; ?>
