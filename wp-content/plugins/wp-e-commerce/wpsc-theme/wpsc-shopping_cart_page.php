...
<table class="checkout_cart">
  ...
  <?php if(wpsc_uses_shipping()): ?>
   ...
   <div id="wpsc_shopping_cart_container new_wpsc_shopping_cart_container">
   <?php if(wpsc_uses_shipping()) : ?>
   ...
   <?php do_action('wpsc_before_form_of_shopping_cart'); ?>
	...
	<?php endif; ?>	
	<form class='wpsc_checkout_forms new_wpsc_checkout_forms' action='<?php echo get_option('shopping_cart_url'); ?>' method='post' enctype="multipart/form-data">
...
<img src='https://secure.gravatar.com/avatar/empty?s=60&amp;d=mm' id='wpsc_checkout_gravatar new_wpsc_checkout_gravatar' />
...
<!-- div for make purchase button -->
      <div class='wpsc_make_purchase nw_wpsc_make_purchase'>
         <span>
            <?php if(!wpsc_has_tnc()) : ?>
